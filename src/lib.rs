...
#[derive(Debug)]
pub struct AIOracleProcessor {
    verbose: bool,
    processed_count: usize,
}

impl AIOracleProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting AIOracle processing");
    
    let mut processor = AIOracleProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = AIOracleProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = AIOracleProcessor::new(false);
